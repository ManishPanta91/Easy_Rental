...
import { duke } from "../../scripts/Images";
import { useNavigate } from "react-router";

const Bike = ({ bikeData }) => {
  console.log("data in bike component", bikeData);
    ...
    <>
      <div className="bg-gray-50 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          {/* Decorative Lines and BIKES text */}
          ...
          {bikeData?.map((bike) => (
            ...
            >
              ...
              <div className="px-3 flex flex-col">
                ...
                <p className="text-center mt-2">{bike?.brand}</p>
                <button
                  onClick={() => nav(`singlevehicle/${bike?.id}`)}
                  className="mt-2 py-4 px-2 rounded-2xl bg-green-400 cursor-pointer"
                >
                  Details
                </button>
              </div>
